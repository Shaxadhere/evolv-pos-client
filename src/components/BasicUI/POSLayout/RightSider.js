...
import {
  ...
  setOrderType,
  setPaymentMethod,
} from "../../../config/redux/slices/cartSlice";
import {
  ORDER_TYPES,
  PAYMENT_METHODS,
    ...
    >
      ...
      >
        <VStack spacing={5}>
          ...
          <VStack w="full" spacing={5} h="calc(100vh - 245px)" overflow={"auto"}>
            {cartItems?.length === 0 && (
        ...
        {cartItems?.length > 0 && (
          <VStack w="full" spacing={3}>
            <Flex align="center" justify="space-between" w="full">
              ...
              <Heading minW="180px" textAlign={"right"} as="h3" fontSize="20px">Total: PKR {calculateTotal().total}</Heading>
            </Flex>
        ...
        footer={
          <Button
            ...
            isDisabled={
              ...
              !amount ||
              amount === "0" ||
              parseFloat(amount) < calculateTotal().total
            }
          >
            Checkout
          </Button>
              ...
              {amount > 0 && (
                <>
                  ...
                  <Flex w="full" justify={"space-between"} align={"center"}>
                    ...
                    <Text fontSize={"16px"} fontWeight={"bold"}>
                      Rs. {amount - calculateTotal().total}
                    </Text>
                  </Flex>
                </>
              )}
          ...
          <VStack spacing={3} mt={5} w="full">
            ...
            <SimpleGrid columns={3} w="full" spacing={4}>
              {[1, 2, 3, 4, 5, 6, 7, 8, 9, "00", 0, "."].map((item, index) => (
                <Button key={index} onClick={() => handleAmountChange(item)}>
                  {item}
                </Button>
              ))}
            </SimpleGrid>
